...
const ZH = {
  ...
  settings: {
    ...
    generalGroup: '通用',
    summaryPreset: '总结风格预设',
    summaryPresetPlain: '极简白话',
    summaryPresetDetailed: '结构化笔记',
    summaryPresetCritical: '批判分析',
    summaryPresetAction: '行动清单',
    summaryPresetTimeline: '时间轴定位',
    summaryPresetCustom: '自定义',
    customPromptEdit: '编辑自定义 Prompt',
    customPromptCollapse: '收起自定义 Prompt',
    customPromptPlaceholder: '输入自定义总结 Prompt，例如：请总结以下字幕：\n\n{{transcript}}',
    languageGroup: '语言',
    language: '界面显示语言',
    languageZh: '中文',
    languageEn: 'English',
    summaryLanguage: '偏好字幕获取及总结语言',
    sourceGroup: '视频源',
    ...
    textGroup: '文本配置',
    textApiStyle: 'API 协议',
    apiStyleOpenAI: 'Chat Completions 协议',
    apiStyleAnthropic: 'Anthropic 协议',
    ...
    imagePromptPreset: '生图风格预设',
    imagePresetInfographic: '信息图',
    imagePresetCover: '封面图',
    imagePresetPoster: '海报',
    imagePresetIllustration: '插画',
    imagePresetMinimal: '极简',
    imagePresetPixelRpg: 'Pixel RPG',
    customImagePromptPlaceholder: '输入自定义生图 Prompt，使用 {{summary}} 插入当前视频摘要。',
    imageSize: '图片比例',
    imageSizeWide: '横屏 16:9',
    imageSizeClassic: '横屏 4:3',
    imageSizeSquare: '方图 1:1',
    imageSizePortrait: '竖屏 9:16',
    imageSizeTall: '长竖屏 9:21',
    model: '模型',
    baseUrl: 'Base URL',
    ...
    chatgptImageHint: '保持根页打开，完成后自动返回',
  },
} as const;
...
const EN: UiDict = {
  ...
  settings: {
    ...
    summaryPreset: 'Summary Style Preset',
    summaryPresetPlain: 'Plain Summary',
    summaryPresetDetailed: 'Structured Notes',
    summaryPresetCritical: 'Critical Analysis',
    summaryPresetAction: 'Action List',
    summaryPresetTimeline: 'Timeline',
    summaryPresetCustom: 'Custom',
    customPromptEdit: 'Edit custom prompt',
    customPromptCollapse: 'Collapse custom prompt',
    customPromptPlaceholder: 'Enter a custom summary prompt, for example: Summarize this transcript:\n\n{{transcript}}',
    languageGroup: 'Language',
    language: 'Interface Language',
    languageZh: '中文',
    languageEn: 'English',
    summaryLanguage: 'Preferred Subtitle & Summary Language',
    ...
    youtubeApiKey: 'YouTube API Key',
    youtubeOauthToken: 'YouTube OAuth Token',
    textGroup: 'Text Configuration',
    textApiStyle: 'API Protocol',
    apiStyleOpenAI: 'Chat Completions',
    apiStyleAnthropic: 'Anthropic Style',
    summaryAutoRun: 'Auto-run summary on video load',
    statusOn: 'On',
    statusOff: 'Off',
    imageGroup: 'Image Configuration',
    imageMode: 'Image Method',
    imageModeApi: 'Image API',
    imageModeChatGpt: 'ChatGPT Web (Experimental)',
    imagePromptPreset: 'Image Style Preset',
    imagePresetInfographic: 'Infographic',
    imagePresetCover: 'Cover',
    imagePresetPoster: 'Poster',
    imagePresetIllustration: 'Illustration',
    imagePresetMinimal: 'Minimal',
    imagePresetPixelRpg: 'Pixel RPG',
    customImagePromptPlaceholder: 'Enter a custom image prompt. Use {{summary}} for the current video summary.',
    imageSize: 'Image Ratio',
    imageSizeWide: 'Landscape 16:9',
    imageSizeClassic: 'Landscape 4:3',
    imageSizeSquare: 'Square 1:1',
    imageSizePortrait: 'Portrait 9:16',
    imageSizeTall: 'Tall Portrait 9:21',
    model: 'Model',
    baseUrl: 'Base URL',
    imageApiUrl: 'Base URL',
    imageApiKey: 'API Key',
    ...
    chatgptImageHint: 'Keep the root page open; returns when complete.',
  },
};
