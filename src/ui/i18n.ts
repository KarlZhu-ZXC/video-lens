...
const ZH = {
  ...
  oneImage: {
    title: '一图流',
    caption: '用图片模型生成视频总结图并导出 PNG',
    emptyTitle: '还没有一图流预览',
    emptyBody: '图片模型会根据文本摘要直接生成图片。',
    toolbar: '一图流工具',
  },
  settings: {
    title: '设置',
...
const EN: UiDict = {
  ...
  oneImage: {
    title: 'One Image',
    caption: 'Generate a video summary image with the image model',
    emptyTitle: 'No one-image preview yet',
    emptyBody: 'The image model generates an image directly from the text summary.',
...
const EN_STATUS: Record<string, string> = {
  ...
  准备生图提示词: 'Preparing image prompt',
  生成一图流图片: 'Generating summary image',
