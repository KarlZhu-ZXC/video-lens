...
“通用”设置控制打开视频时是否自动提取并生成。“文本配置”通过紧凑的 Radio Chip Group 选择全局总结风格预设；选择“自定义”可展开 Prompt 编辑器，保存后再次打开设置默认折叠。“偏好字幕获取及总结语言”默认中文，用于首次匹配当前视频的字幕轨道；摘要页仍可通过“字幕”胶囊下拉切换该视频的具体轨道。
